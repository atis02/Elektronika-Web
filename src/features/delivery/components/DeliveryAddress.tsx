...
//     if (value.length > 9) {
//       value = value.slice(0, 9); // Ограничиваем длину до 9 цифр (XX XXX-XXX)
//     }
...
//               onChange={index == 6 ? handlePhoneChange : handleInputChange}
//               fullWidth
//               type={input.type}
...
const DeliveryAddress: FC<DeliveryTypeProps> = ({
  ...
  console.log(errors.customerPhoneNumber);
