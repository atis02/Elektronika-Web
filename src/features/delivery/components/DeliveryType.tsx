...
interface DeliveryTypeProps {
  selectedCard: number; // Adjust this type based on your actual data type
  hasError?: boolean; // Optional if not always required
...
const DeliveryType: FC<DeliveryTypeProps> = ({
  ...
  // State to keep track of selected card and error state
